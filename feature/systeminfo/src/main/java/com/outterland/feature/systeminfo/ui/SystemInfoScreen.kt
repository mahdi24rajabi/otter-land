...
fun SystemInfoScreen() {
    val cardColors = CardDefaults.elevatedCardColors(containerColor = MaterialTheme.colorScheme.surfaceContainerLow)
    val carElevation = CardDefaults.elevatedCardElevation(defaultElevation = 1.dp)
